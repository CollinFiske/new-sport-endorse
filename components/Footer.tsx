        ...
        <div className="footer-top">
          <div className="newsletter">
            ...
            <div className="all-social-logos">
              ...
              <span><a target="_blank" href="https://www.instagram.com/sport_endorse/"><Image src="/images/instagramLogo.webp" alt="instagram logo" width={32} height={32} className="social-logo" /></a></span>
              <span><a target="_blank" href="https://www.linkedin.com/company/sportendorse/"><Image src="/images/tiktokLogo.webp" alt="tiktok logo" width={32} height={32} className="social-logo" /></a></span>
              <span><a target="_blank" href="https://www.tiktok.com/@sportendorse"><Image src="/images/linkedinLogo.webp" alt="linkedin logo" width={32} height={32} className="social-logo" /></a></span>
              <span><a target="_blank" href="https://open.spotify.com/show/2c2mWOkxmUpeGyFI2dZgC5"><Image src="/images/spotify.png" alt="spotify logo" width={32} height={32} className="social-logo" /></a></span>
              <span><a target="_blank" href="https://www.youtube.com/channel/UCwHt-_eNBHav6TSihoirZIA"><Image src="/images/youtube icon.png" alt="youtube logo" width={32} height={32} className="social-logo" /></a></span>
            </div>
