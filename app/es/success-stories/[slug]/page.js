...
export async function generateMetadata({ params }) {
  try {
    ...
    return {
      ...
      description,
      alternates: {
        canonical: `https://www.sportendorse.com/es/success-stories/${resolvedParams.slug}`
      },
      openGraph: {
        title,
        description,
            ...
            <article className="blog-post-article">
              <header className="blog-post-article-header">
                ...
                <div className="blog-post-article-meta">
                  <time>{publishDate ? publishDate.toLocaleDateString('es-ES') : 'Fecha no disponible'}</time>
                  ...
                  {story.content?.rendered ? (
                    ...
                    <div>
                      ...
                      <div style={{ 
                        ...
                        <h3 style={{ color: '#6c757d', marginBottom: '1rem' }}>Detalles de la Historia de Éxito</h3>
                        <p style={{ color: '#6c757d' }}>
                          Esta historia de éxito muestra una asociación facilitada por Sport Endorse. 
                          Para obtener más detalles sobre esta colaboración, póngase en contacto con nosotros.
                        </p>
                        {story.yoast_head_json?.og_image?.[0]?.url && (
