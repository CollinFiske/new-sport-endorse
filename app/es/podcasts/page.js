...
export const metadata = {
  ...
  title: "Podcast de Sport Endorse: Patrocinio de Atletas y Marketing de Influencers | Sport Endorse",
  description: "Escuche el podcast de Sport Endorse para obtener información sobre patrocinio de atletas, influencers deportivos y estrategias de marketing deportivo. Escuche de atletas y expertos de la industria.",
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ color: '#9ca3af', padding: '0.25rem' }}>
            <svg style={{ width: '1.25rem', height: '1.25rem' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <a href={`/es/podcasts/${podcast.slug}`}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z" />
              </a>
            </svg>
          </div>
          <Link href={`/es/podcasts/${podcast.slug}`}>
            <button 
              style={{
          ...
          <div className="podcast-header-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 1rem' }}>
            <div style={{ textAlign: 'center' }}>
              <h1 className="podcast-header-title" style={{ fontSize: '2.5rem', fontWeight:'800', color: '#111827', marginBottom: '1.25rem' }}>
                La Charla del Atleta
              </h1>
              <p className="podcast-header-description" style={{ fontSize: '1.125rem', color: '#6b7280', maxWidth: '512px', margin: '0 auto' }}>
                Descubre historias inspiradoras y perspectivas de atletas de clase mundial y profesionales del deporte
              </p>
              ...
              <div className="podcast-info-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', fontSize: '0.875rem', color: '#6b7280', flexWrap: 'wrap' }}>
                ...
                <span>Descubrir Podcasts de Sport Endorse</span>
                <span className="podcast-info-separator">•</span>
        ...
        <main className="blog-main">
          {podcasts.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '3rem 0' }}>
              ...
              <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#111827', marginBottom: '0.5rem' }}>No se encontraron podcasts</h2>
              <p style={{ color: '#6b7280' }}>¡Vuelve más tarde para nuevos episodios!</p>
            </div>
          ) : (
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#111827', marginBottom: '0.5rem' }}>Algo salió mal</h2>
