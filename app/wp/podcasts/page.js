...
import { fetchPodcasts, stripHtml, formatDate, createExcerpt, generatePodcastIframe, extractAudioUrl } from './wordpress.js';
...
function PodcastCard({ podcast }) {
  ...
  const audioUrl = extractAudioUrl(podcast);
  const iframeHtml = generatePodcastIframe(podcast);
      ...
      <header style={{ backgroundColor: 'white', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1rem' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', fontSize: '0.875rem', color: '#6b7280' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1rem' }}>
          <div style={{ textAlign: 'center' }}>
            <p style={{ color: '#6b7280', marginBottom: '1rem' }}>
              Powered by Sport Endorse - Sports Management Agency
            </p>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem' }}>
              <Link 
                href="https://www.sportendorse.com"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#2563eb', textDecoration: 'none', transition: 'color 0.3s ease' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = '#1d4ed8';
                }}
                onMouseLeave={(e) => {
              ...
              <Link 
                href="https://www.sportendorse.com/podcasts"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#2563eb', textDecoration: 'none', transition: 'color 0.3s ease' }}
                onMouseEnter={(e) => {
