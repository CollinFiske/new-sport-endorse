...
export default function TermsAndConditions() {
  return (
    ...
    <p>
        ...
        &apos;User” means the person, firm or corporate body together with any company which is related to the User that uses the Sport Endorse Service or application, including all Brands, Agencies, and Talent (also may be referred to as &apos;you&apos; or &apos;your&apos;);
        ...
        <br />2. OVERVIEW OF SERVICE AND UPDATES<br />
        ...
        3.6 Notices. By providing an email address, you consent to Sport Endorse using the email address to send you notices related to the Service and/or special offers. You may choose to opt out of messages (to the extent the messages are not required by law). Opting out may prevent you from receiving important notices regarding updates, improvements, or offers.

        3.7 Prohibited Activities. You may not:<br />
        (i) use any robot, spider, scraper or other automated means to access the Service;<br />
        (ii) interfere or attempt to interfere with the proper operation, system integrity, or security of the Service;<br />
        (iii) attempt to circumvent the Service and associated Commissions (as described in these Terms);<br />
        (iv) use the Service to advertise or promote a competing website, product, or service;<br />
        (v) copy, reproduce, modify, create derivative works from, distribute, or publicly display any part of the Service or any Content that is not your own;<br />
        (vi) collect or harvest any personally identifiable information from the Service.<br />
        ...
        <br />4. DEALS AND DEAL PAYMENTS<br />
        ...
        <br />7. COPYRIGHT INFRINGEMENT NOTICES<br />
        ...
        9.2 Access to Third Party Websites. If User access a third-party website from the Service, User does so at your own risk, and User understand that neither these Terms nor Sport Endorse&apos;s Privacy Policy apply to your User&apos;s use of such sites.
        
        <br />10. WARRANTY DISCLAIMER<br />
        ...
        10.2 Necessary Technology. Use of the Service requires; (i) compatible devices, (ii) internet access, (iii) certain software (for which fees may apply), (iv) may require periodic updates, and (v) may be affected by the performance of these factors. High speed internet access is strongly recommended for regular use and is required for video. The latest version of required software is recommended to access the Service and may be required for certain transactions or features. You agree that meeting these requirements, which may change from time to time, is your responsibility. The Service are not part of any other product or offering, and no purchase or obtaining of any other product shall be construed to represent or guarantee you access to the Service.
        
        10.3 Third Party Materials. Certain services may include materials from third parties. Sport Endorse may provide links to third-party websites as a convenience to you. User agrees that Sport Endorse is not responsible for examining or evaluating the content or accuracy and Sport Endorse does not warrant and will not have any liability or responsibility for any third-party materials or websites, or for any other materials, products, or services of third parties. User agrees that it will not use any third-party materials in a manner that would infringe or violate the rights of any other party and that Sport Endorse is not in any way responsible for any such use by you.
        ...
        <br />11. LIMITATION OF LIABILITY AND RELEASE<br />
        ...
        <br />12. ASSIGNMENT & CONFIDENTIALITY<br />
        ...
        <br />14. ENTIRE AGREEMENT/SEVERABILITY<br />
    ...
    <p>
        <strong>PART B: ADDITIONAL TERMS APPLICABLE TO BRANDS/AGENCIES</strong><br />
        
        <br />1. Age. No person under 16 maybe a User and Brands must use best endeavours to ensure that no personal information in respect of a person who is under the age of 16 years is submitted to Sport Endorse. We will not knowingly accept any data from a Brand or Agency in respect of a person who is under the age of 16 years.

        <br />2. Venue. Brands and Agencies agree that it is their responsibility to ensure that any venues or locations in which the engagement with the Talent is held is safe, fit for purpose and with adequate security.

        <br />3. Brand/Agency. Brands and Agencies shall sign up to Sport Endorse for a subscription plan. This may offer support from an account manager (such plans being &apos;Subscription Plans”). Subscription Plans are non-refundable within the initial service term. All Subscription Plans are automatically renewed until cancelled by the User prior to any such renewal, in writing to Sport Endorse via email to subscriptions@sportendorse.com. In instances where the credit card on file fails, we will contact the Brand/Agency email on file for an alternate payment method. If there is no response, we will follow up with the Brand/Agency&apos;s financial team.

        <br />4. Cancelation of Subscription Plan. A Brand/Agency may cancel a subscription to a Subscription Plan at any time after the initial service term is complete and there are no open Sponsorship Contracts in the account (i.e. deals where a proposal has been accepted by the Talent but the opportunity has not yet been completed). Cancelation requests must be made in writing to the Sport Endorse account manager or to subscriptions@sportendorse.com. In the event we cancel your Subscription Plan for failure to comply with these Terms, you will forfeit the remainder of your subscription term; we will not issue a refund.sportendorse
    </p>
    <p>
        <strong>PART C: ADDITIONAL TERMS APPLICABLE TO TALENT</strong><br />
        
        <br />1. Intellectual Property. The Talent acknowledges that the Service and all software, images, text, graphics, illustrations, logos, patents, trademarks, service marks, copyrights, photographs and other content within the Service (&apos;Sport Endorse Content”), and all intellectual property rights in the foregoing, are the exclusive property of Sport Endorse and its licensors. Except as expressly provided herein, nothing in these Terms shall be deemed to create a license to use Sport Endorse Content. Use of Sport Endorse Content for any purpose not expressly permitted by these Terms is prohibited.

        <br />2. Ownership of Sport Endorse. The Talent acknowledges and agrees that Sport Endorse and/or its licensors own all Information and Intellectual Property Rights in the Service. Except as expressly stated herein, this agreement does not grant you any rights to, under or in, any patents, copyright, database right, trade secrets, trade names, trademarks (whether registered or unregistered), or any other rights or licences in respect of the Service. To the extent that any modifications or improvements to the Service are carried out under or in connection with this Agreement, whether by Sport Endorse alone or jointly with the Talent, and whether based on the Talent&apos;s ideas or suggestions from, all Intellectual Property Rights to such underlying ideas and in any resulting improvement or modifications shall be assigned to and shall vest with and be solely owned by Sport Endorse and/or its licensors.

        <br />3. Grant of Non Exclusive Right. If the Talent posts content or submits material to Sport Endorse, and unless otherwise indicated, you grant us a non-exclusive, royalty-free and fully sub-licensable and transferable rights to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display the content throughout the world in any media.

        <br />4. All Talent using the Service provided by Sport Endorse agrees with Sport Endorse that:

        <br />4.1 Sport Endorse has the unrestricted right to depict the Talent, by way of photograph or film (whether provided by the Talent or created by Sport Endorse) as permitted by law, using any technology or media including but not limited to digital, electronic, print, film and television media now known or yet to be invented relating to the promotion of the business activities of Sport Endorse while the Talent is using the Service of Sport Endorse;

        <br />4.2 Sport Endorse may generate and use images of the Talent on a nonexclusive basis in media or for promotional purposes throughout the World;

        <br />4.3 Any images or depictions of the Talent generated by Sport Endorse may be edited, stored, copies made of and reused at the sole desertion of Sport Endorse;

        <br />4.4 The Talent releases Sport Endorse from any future claim made by me or anyone else arising out of the use of the images or depictions of the Talent;

        <br />4.5 No consideration is due to the Talent for this release;

        <br />4.6 This release is irrevocable and worldwide for the period while the Talent is using the service of Sport Endorse and will be governed by the law of The Republic of Ireland;

        <br />4.7 The Talent has read this release and fully understands the contents and consequences of this release and accept that it will be fully binding on the Talent.
    </p>
    </main>
    </>
  );
