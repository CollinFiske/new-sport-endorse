export interface FeaturedTalent {
  name: string;
  image: string;
  followingInstagram?: string;
  followingTiktok?: string;
  sport: string;
  location: string;
}
...
export const featuredTalentsData = {
  ...
  es: [
    ...
    },
    {
      name: "Abby Berner",
      image: "/images/featuredTalent/abby berner.png",
      followingInstagram: "220K",
      sport: "Influencer/Boxing",
      location: "Madrid, Spain"
    },
    {
      name: "Alejandra de Benito",
      image: "/images/featuredTalent/Alejandra de Benito.jpeg",
      followingInstagram: "183k",
      followingTiktok: "328k",
      sport: "Atletismo",
